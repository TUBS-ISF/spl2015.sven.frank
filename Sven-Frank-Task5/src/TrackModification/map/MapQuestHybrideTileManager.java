 ...
 *
 */
public  class  MapQuestHybrideTileManager  extends TileManager {
	
	public MapQuestHybrideTileManager() {
		setMapName("MapQuestHybride");
	...
	public String getTileURL(TileNumber tileNumber) {
		...
		return getBaseURL()+"/getmap?key=Fmjtd%7Cluubn96ynu%2C2s%3Do5-907guw&size=256,256&type=hyb&zoom="+
